...
describe("intersperse", () => {
  ...
  it("intersperse", () => {
    ...
    expect(Array.from(intersperse("foo", [1, 2, 3, 4]))).toEqual([
      1,
      "foo",
      2,
      "foo",
...
describe("roundrobin", () => {
  ...
  it("roundrobin on unequally sized lists", () => {
    ...
    expect(Array.from(roundrobin([1, 2, 3, 4, 5], [6, 7]))).toEqual([
      1,
      6,
      2,
      7,
    ...
    expect(Array.from(roundrobin([1, 2, 3], [4], [5, 6, 7, 8]))).toEqual([
      1,
      4,
      5,
      2,
...
describe("heads", () => {
  ...
  it("heads on equally sized lists", () => {
    ...
    expect(Array.from(heads("foo", "bar")).map((s) => s.join(""))).toEqual([
      "fb",
      "oa",
      "or",
    ]);
  ...
  it("heads on unequally sized lists", () => {
    ...
    expect(Array.from(heads([1, 2, 3, 4, 5], [6, 7]))).toEqual([
      [1, 6],
      [2, 7],
      [3],
      [4],
    ...
    expect(Array.from(heads([1, 2, 3], [4], [5, 6, 7, 8]))).toEqual([
      [1, 4, 5],
      [2, 6],
      [3, 7],
      [8],
...
describe("uniqueJustseen", () => {
  ...
  it("uniqueJustseen", () => {
    expect(Array.from(uniqueJustseen([1, 2, 3, 4, 5]))).toEqual([
      1,
      2,
      3,
      4,
    ...
    expect(Array.from(uniqueJustseen([1, 1, 1, 2, 2, 1, 1, 1, 1]))).toEqual([
      1,
      2,
      1,
    ]);
  ...
  it("uniqueEverseen with key function", () => {
    expect(Array.from(uniqueJustseen("AaABbBCcaABBb", (s) => s.toLowerCase())))
      .toEqual(["A", "B", "C", "a", "B"]);
  });
});
...
describe("uniqueEverseen", () => {
  ...
  it("uniqueEverseen never emits dupes, but keeps input ordering", () => {
    expect(Array.from(uniqueEverseen([1, 2, 3, 4, 5]))).toEqual([
      1,
      2,
      3,
      4,
    ...
    expect(Array.from(uniqueEverseen([1, 1, 1, 2, 2, 3, 1, 3, 0, 4]))).toEqual([
      1,
      2,
      3,
      0,
    ...
    expect(Array.from(uniqueEverseen([1, 1, 1, 2, 2, 1, 1, 1, 1]))).toEqual([
      1,
      2,
    ]);
  });
  ...
  it("uniqueEverseen with key function", () => {
    expect(Array.from(uniqueEverseen("AAAABBBCCDAABBB"))).toEqual([
      "A",
      "B",
      "C",
      "D",
    ]);
    expect(Array.from(uniqueEverseen("ABCcAb", (s) => s.toLowerCase())))
      .toEqual(["A", "B", "C"]);
    expect(Array.from(uniqueEverseen("AbCBBcAb", (s) => s.toLowerCase())))
      .toEqual(["A", "b", "C"]);
  });
});
